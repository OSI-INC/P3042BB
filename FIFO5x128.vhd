...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n FIFO5x128 -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 128 -width 40 -rwidth 40 -no_enable -pe 10 -pf 120 

-- Thu Dec 08 19:47:47 2022
...
architecture Structure of FIFO5x128 is
...
begin
    ...
    FIFO5x128_0_2: FIFO8KB
        generic map (FULLPOINTER1=> "0b00011111110000", FULLPOINTER=> "0b00100000000000", 
    ...
    FIFO5x128_2_0: FIFO8KB
        ...
        port map (DI0=>Data(36), DI1=>Data(37), DI2=>Data(38), 
            ...
            CSR1=>scuba_vhi, FULLI=>Full_int, EMPTYI=>Empty_int, 
            WE=>WrEn, RE=>RdEn, ORE=>RdEn, CLKW=>WrClock, CLKR=>RdClock, 
            RST=>Reset, RPRST=>RPReset, DO0=>open, DO1=>open, DO2=>open, 
            DO3=>open, DO4=>open, DO5=>open, DO6=>open, DO7=>open, 
            DO8=>open, DO9=>Q(36), DO10=>Q(37), DO11=>Q(38), DO12=>Q(39), 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of FIFO5x128 is
    for Structure
