...
-- Module  Version: 7.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n CPU_RAM -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 1000 -addr_width 13 -data_width 8 -num_rows 6144 -cascade -1 -mem_init0 -writemode NORMAL 
...
architecture Structure of CPU_RAM is
    ...
    attribute MEM_LPC_FILE of CPU_RAM_0_0_5 : label is "CPU_RAM.lpc";
    attribute MEM_INIT_FILE of CPU_RAM_0_0_5 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of CPU_RAM_0_1_4 : label is "CPU_RAM.lpc";
    attribute MEM_INIT_FILE of CPU_RAM_0_1_4 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of CPU_RAM_0_2_3 : label is "CPU_RAM.lpc";
    attribute MEM_INIT_FILE of CPU_RAM_0_2_3 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of CPU_RAM_0_3_2 : label is "CPU_RAM.lpc";
    attribute MEM_INIT_FILE of CPU_RAM_0_3_2 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of CPU_RAM_1_0_1 : label is "CPU_RAM.lpc";
    attribute MEM_INIT_FILE of CPU_RAM_1_0_1 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of CPU_RAM_1_1_0 : label is "CPU_RAM.lpc";
    attribute MEM_INIT_FILE of CPU_RAM_1_1_0 : label is "INIT_ALL_0s";
...
begin
    ...
    CPU_RAM_0_0_5: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>scuba_vlo, DIA6=>scuba_vlo, 
            ...
            WEA=>WE, CSA2=>scuba_vlo, CSA1=>scuba_vlo, CSA0=>Address(12), 
            ...
            DOA5=>open, DOA4=>open, DOA3=>open, DOA2=>open, 
    ...
    CPU_RAM_0_1_4: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>scuba_vlo, DIA6=>scuba_vlo, 
            ...
            RSTB=>scuba_vlo, DOA8=>open, DOA7=>open, DOA6=>open, 
            DOA5=>open, DOA4=>open, DOA3=>open, DOA2=>open, 
            DOA1=>mdout0_0_3, DOA0=>mdout0_0_2, DOB8=>open, DOB7=>open, 
            DOB6=>open, DOB5=>open, DOB4=>open, DOB3=>open, DOB2=>open, 
            DOB1=>open, DOB0=>open);
    ...
    CPU_RAM_0_3_2: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>scuba_vlo, DIA6=>scuba_vlo, 
            ...
            RSTB=>scuba_vlo, DOA8=>open, DOA7=>open, DOA6=>open, 
            DOA5=>open, DOA4=>open, DOA3=>open, DOA2=>open, 
            DOA1=>mdout0_0_7, DOA0=>mdout0_0_6, DOB8=>open, DOB7=>open, 
            DOB6=>open, DOB5=>open, DOB4=>open, DOB3=>open, DOB2=>open, 
            DOB1=>open, DOB0=>open);
    ...
    CPU_RAM_1_0_1: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>scuba_vlo, DIA6=>scuba_vlo, 
            ...
            ADA0=>scuba_vlo, CEA=>ClockEn, OCEA=>ClockEn, CLKA=>Clock, 
            WEA=>WE, CSA2=>scuba_vlo, CSA1=>Address(12), 
            CSA0=>Address(11), RSTA=>Reset, DIB8=>scuba_vlo, 
            ...
            DOA6=>open, DOA5=>open, DOA4=>open, DOA3=>mdout0_1_3, 
            DOA2=>mdout0_1_2, DOA1=>mdout0_1_1, DOA0=>mdout0_1_0, 
    ...
    CPU_RAM_1_1_0: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>scuba_vlo, DIA6=>scuba_vlo, 
            ...
            WEB=>scuba_vlo, CSB2=>scuba_vlo, CSB1=>scuba_vlo, 
            CSB0=>scuba_vlo, RSTB=>scuba_vlo, DOA8=>open, DOA7=>open, 
            DOA6=>open, DOA5=>open, DOA4=>open, DOA3=>mdout0_1_7, 
            DOA2=>mdout0_1_6, DOA1=>mdout0_1_5, DOA0=>mdout0_1_4, 
            DOB8=>open, DOB7=>open, DOB6=>open, DOB5=>open, DOB4=>open, 
            DOB3=>open, DOB2=>open, DOB1=>open, DOB0=>open);
    ...
    mux_7: MUX21
        port map (D0=>mdout0_0_0, D1=>mdout0_1_0, SD=>addr12_ff, Z=>Q(0));

    mux_6: MUX21
        port map (D0=>mdout0_0_1, D1=>mdout0_1_1, SD=>addr12_ff, Z=>Q(1));

    mux_5: MUX21
        port map (D0=>mdout0_0_2, D1=>mdout0_1_2, SD=>addr12_ff, Z=>Q(2));

    mux_4: MUX21
        port map (D0=>mdout0_0_3, D1=>mdout0_1_3, SD=>addr12_ff, Z=>Q(3));

    mux_3: MUX21
        port map (D0=>mdout0_0_4, D1=>mdout0_1_4, SD=>addr12_ff, Z=>Q(4));

    mux_2: MUX21
        port map (D0=>mdout0_0_5, D1=>mdout0_1_5, SD=>addr12_ff, Z=>Q(5));

    mux_1: MUX21
        port map (D0=>mdout0_0_6, D1=>mdout0_1_6, SD=>addr12_ff, Z=>Q(6));

    mux_0: MUX21
        port map (D0=>mdout0_0_7, D1=>mdout0_1_7, SD=>addr12_ff, Z=>Q(7));
