...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n FIFO24 -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 256 -width 24 -rwidth 24 -no_enable -pe 6 -pf 250 

-- Fri May 10 22:13:39 2024
...
architecture Structure of FIFO24 is
...
begin
    ...
    FIFO24_0_1: FIFO8KB
        ...
        AEPOINTER1=> "0b00000001110000", AEPOINTER=> "0b00000001100000", 
    ...
    FIFO24_1_0: FIFO8KB
        ...
        port map (DI0=>Data(18), DI1=>Data(19), DI2=>Data(20), 
            DI3=>Data(21), DI4=>Data(22), DI5=>Data(23), DI6=>scuba_vlo, 
            ...
            DO13=>Q(22), DO14=>Q(23), DO15=>open, DO16=>open, DO17=>open, 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of FIFO24 is
    for Structure
